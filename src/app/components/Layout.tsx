        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10 md:gap-8 pb-12">
          ...
          <div className="flex flex-col items-start gap-5 max-w-sm">
            <div className="flex items-center gap-4 -mt-3">
              <img src={icsscLogoWhite} alt="CICS Student Council Logo" className="h-12 md:h-[68px] w-auto" />
          ...
          <div className="flex flex-col">
            ...
            <ul className="flex flex-col gap-3 text-white">
              <li><Link to="/about/council" className="hover:text-[#AA0924] transition-colors text-sm md:text-base font-normal whitespace-nowrap">The Council</Link></li>
              <li><Link to="/about/members" className="hover:text-[#AA0924] transition-colors text-sm md:text-base font-normal whitespace-nowrap">Meet the Council Members</Link></li>
          ...
          <div className="flex flex-col max-w-xs">
            ...
            <div className="flex flex-col gap-3 text-white">
              <div className="flex items-start gap-3">
                <svg width="18" height="18" viewBox="0 0 24 24" fill="#AA0924" className="mt-1 shrink-0">
                  <path d="M20 4H4c-1.1 0-1.99.9-1.99 2L2 18c0 1.1.9 2 2 2h16c1.1 0 2-.9 2-2V6c0-1.1-.9-2-2-2zm0 4l-8 5-8-5V6l8 5 8-5v2z"/>
                </svg>
                <a href="mailto:sc.cics@ust.edu.ph" className="hover:text-[#AA0924] transition-colors text-sm md:text-base font-normal">sc.cics@ust.edu.ph</a>
              </div>
              <div className="flex items-start gap-3">
                <svg width="18" height="18" viewBox="0 0 24 24" fill="#AA0924" className="mt-1 shrink-0">
